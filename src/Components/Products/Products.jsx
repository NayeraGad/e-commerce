        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-y-5">
          {products.map((product) => (
            <Link to={`/productDetails/${product._id}`} key={product._id}>
              <div className="group cursor-pointer hover:rounded-md transition-shadow duration-500 hover:shadow-[1px_1px_10px_#4fa74f] overflow-hidden px-5 md:px-3 py-6">
